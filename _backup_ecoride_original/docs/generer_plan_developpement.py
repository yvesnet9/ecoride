# -*- coding: utf-8 -*-
"""
Script pour générer automatiquement le document :
Ecoride_Plan_Developpement.md
Auteur : Yves Mukuna Jamesy
Année : 2025
"""
...
output_path = os.path.join(os.path.dirname(__file__), "Ecoride_Plan_Developpement.md")

# 📝 Contenu du document Markdown
content = """![Ecoride Logo](Ecoride_logo.png)
...
print(f"📅 Date de génération : {date.today()}")
